...
- Initial release of `@visual-json/vue` — Vue 3 components for visual-json.
- `VisualJson` provider component with state management, history, and search.
...
- `DiffView` — side-by-side diff viewer for JSON changes.
